              ...
              CupertinoButton.filled(
                ...
                child: const Text(
                  ...
                  style: TextStyle(
                      ...
                      color: Colors.black),
                  semanticsLabel: 'select photo to apply filter on',
                ),
              ),
              ...
              ToggleButtons(
                  ...
                  children: [
                    const Padding(
                      ...
                      semanticsLabel: 'apply filter on highlights',),
                    ),
                    const Padding(
                      padding: EdgeInsets.symmetric(horizontal: 30),
                      child: Text('Shadows',
                          style:
                              TextStyle(fontFamily: 'KodeMono', fontSize: 21),
                          semanticsLabel: 'apply filter on shadows'),
                    )
                  ],
              ...
              CupertinoButton.filled(
                ...
                child: const Text(
                  ...
                  style: TextStyle(
                      ...
                      fontWeight: FontWeight.bold,
                      color: Colors.black),
                  semanticsLabel: 'generate maragram image',
                ),
              ),
              const SizedBox(height: 50),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: const Text('Details', style: TextStyle(
                      ...
                      fontWeight: FontWeight.bold,
                      color: Colors.white),
                  semanticsLabel: 'check info about this app',),
                ),
              ),
            ],
          ),
            ...
            const Center(
              child: Text(
                ...
                style: TextStyle(
                    ...
                    fontWeight: FontWeight.bold,
                    color: Colors.white),
                semanticsLabel: 'Simple solarization app to apply the Dart Image Package filter I helped write. Solarization is the partial inversion if an image. Highlights and Shadows refer to where the solarization will take place. Threshold defines the pixels value up to where the effect will take place. App by Guilherme Maranhao. Check out my other experimental projects at refotografia.wordpress.com',
              ),
            ),
            const SizedBox(height: 50),
            Center(
